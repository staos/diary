...
public class HotFragment extends Fragment implements PullToRefreshView.OnRefreshListener,View.OnTouchListener,AdapterView.OnItemClickListener{
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        pullToRefreshView = (PullToRefreshView)view.findViewById(R.id.hot_pull_to_refresh);
        pullToRefreshView.setOnRefreshListener(this);
        importComment();
        listView = (RefreshListView) view.findViewById(R.id.hotListView);
