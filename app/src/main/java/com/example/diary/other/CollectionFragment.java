...
public class CollectionFragment extends Fragment implements PullToRefreshView.OnRefreshListener,View.OnTouchListener{
    ...
    private _User myUser = _User.getCurrentUser(_User.class);
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        pullToRefreshView = (PullToRefreshView)view.findViewById(R.id.collection_pull_to_refresh);
        pullToRefreshView.setOnRefreshListener(this);
        importComment();
        listView = (RefreshListView) view.findViewById(R.id.collectionListView);
    ...
    private liveCommentResult liveCommentResult = new liveCommentResult() {
        @Override
    ...
    public  void liveCommentEdit(final Activity context, View view, final liveCommentResult commentResult) {
